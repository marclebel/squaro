  ...
  render: function() {
    return (
      React.createElement("div", {className: "circle", onClick: this.handleClick}, 
        "Hello, world! I am a circle value ", this.props.value, " and key ", this.props.index, "."
      )
    );
  }
});
...
var Grid = React.createClass({displayName: "Grid",
    ...
    handleClick: function (childComponent) {
    	console.log("handleClick " + childComponent.props.index);
    ...
    render: function() {
       ...
       React.createElement("div", {className: "grid"}, 
          ...
          return (
            React.createElement(Circle, {handler: this.handleClick, index: i, value: value})
          );
        }, this), 
